...
<template>
  <header class=" bg-white shadow-md">
    <div class="flex items-center justify-between py-4 px-6 w-full md:w-[1280px] mx-auto full-width">
      <!-- Logo -->
      ...
      <div class="flex items-center space-x-3 md:hidden">
        ...
        <a href="tel:+998 99 941 30 30" class="p-2 rounded-full text-white">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
