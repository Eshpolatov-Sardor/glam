...
<template>
  <div class="fixed top-0 left-0 right-0 z-10 bg-white">
    <div
      class="flex items-center justify-between py-4 w-full container mx-auto"
    >
      <!-- Logo -->
      <div class="text-2xl font-bold">
        <span class="text-gray-900">NANO</span
        ><span class="text-blue-500">WASH</span>
      </div>

      <!-- Links -->
      <nav class="hidden md:flex space-x-6 text-lg text-gray-800">
        <a href="#" class="hover:text-blue-600">Biz</a>
